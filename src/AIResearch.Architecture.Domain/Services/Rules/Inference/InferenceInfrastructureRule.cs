...
internal class InferenceInfrastructureRule(
    IArchitectureLayersProvider layersProvider,
    IComponentRoleProvider roleProvider)
    : LayerInferenceRuleBase(layersProvider, roleProvider, LayerType.Infrastructure)
{
    public override string Id => "INFE-003";
}